...
class YourReviewViewModel(application: Application) :
    ...
    fun refresh(idResto: String, userId: String) {
        loadingLD.value = true
        reviewLoadErrorLD.value = false
        queue = Volley.newRequestQueue(getApplication())
        val url = "https://my-json-server.typicode.com/Cekepek/JsonUbayaKuliner/reviews?restoId="+idResto+"&userId="+userId
